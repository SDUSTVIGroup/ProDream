...
from diffusers.models.attention_processor import Attention, LoRALinearLayer
...
class ControlLoRACrossAttnProcessorV2(LoRACrossAttnProcessor):
    ...
    def __call__(
        self, attn: Attention, hidden_states, encoder_hidden_states=None, attention_mask=None, scale=1.0, batch_size=1
    ):
        pre_lora: LoRACrossAttnProcessor
        post_lora: LoRACrossAttnProcessor
        assert self.control_states is not None
